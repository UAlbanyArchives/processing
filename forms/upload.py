...
from forms.custom_validators import validate_packageID, validate_refID_recreate
...
class UploadForm(Form):
    ...
    refID = StringField('Ref ID', [validators.Length(min=6, max=32), validate_refID_recreate])
